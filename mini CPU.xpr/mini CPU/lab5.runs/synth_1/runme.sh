...
HD_PWD='C:/Users/fatma/OneDrive/Desktop/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log labv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source labv.tcl
